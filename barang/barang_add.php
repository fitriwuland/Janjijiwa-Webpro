...
<img src="logo.png" alt="" style="height: 100px; width:250px; margin-left:540px;">
    ...
    <h2 style="text-align:center; margin">Add New Product </h2>
    ...
    <div class="kotak-add" style="margin-top:-15px; margin-left:25%;">
        ...
        <p><input type="text" name="kdbrg" id="kdbrg"></p>

        <label>Nama Barang</label>
        <p><input type="text" name="nmbrg" id="nmbrg"></p>

        <label>Price </label>
        <p><input type="text" name="hrgbrg" id="hrgbrg"></p>
        </div>

        <div class="kotak" style="text-align:left; margin-left:60%; margin-top:-223px;">

        <label>Stock </label>
        <p><input type="text" name="stokbrg" id="stokbrg"></p>

        <label> Image </label>
        <p><input type="file" name="gambar" id="gambar"></p>

        <label>Deskripsi</label>
        <p><input type="text" name="deskripsi" id="deskripsi"></p>
        </div>
        <div>
            <p style="text-align:center; curso:pointer;"><input type="submit" name="button" id="buton" value="Simpan"></p>
